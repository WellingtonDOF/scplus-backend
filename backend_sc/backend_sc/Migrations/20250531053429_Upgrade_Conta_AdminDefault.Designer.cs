...
namespace backend_sc.Migrations
{
    ...
    [Migration("20250531053429_Upgrade_Conta_AdminDefault")]
    partial class Upgrade_Conta_AdminDefault
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend_sc.Models.PessoaModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Cpf = "00000000000",
                            DataNascimento = new DateTime(2025, 5, 31, 2, 34, 28, 829, DateTimeKind.Local).AddTicks(3736),
                            Email = "Default@sistema.com",
                            Endereco = "RuaDefault",
                            NomeCompleto = "AdminDefault",
                            PermissaoId = 2,
                            Senha = "$2a$11$YMVdH4u5Cf4Y/5pCED0WqOFVLjTRFO5kQclCCabslqDLN.hlym/ZS",
                            Status = true,
                            Telefone = "0000000000"
                        });
                });
